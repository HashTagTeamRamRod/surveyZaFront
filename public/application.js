...
var updateResults = function updateResults(surveyId, answer, data) {
  // console.log('data is', data)
  // console.log('answer is ', answer)
  var content = data.survey.questions[0].content;
  var answer1 = data.survey.questions[0].responses[0].answer1;
  var answer2 = data.survey.questions[0].responses[0].answer2;
  var answer1Count = data.survey.questions[0].responses[0].answer1Count;
  var answer2Count = data.survey.questions[0].responses[0].answer2Count;
...
var show = function show(surveyId) {
  return $.ajax({
    url: config.apiOrigin + '/surveys/' + surveyId,
    method: 'GET'
  });
};
var destroy = function destroy(surveyId) {
  return $.ajax({
    url: config.apiOrigin + '/surveys/' + surveyId,
    method: 'DELETE',
    headers: {
...
var surveyEvents = __webpack_require__(17);
...
var onGetSuccess = function onGetSuccess(event) {
  event.preventDefault();
...
var onCreateSuccess = function onCreateSuccess(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  // console.log('data is ', data)
  api.create(data).then(ui.createSuccess).catch(ui.failure);
};

var onUpdateSuccess = function onUpdateSuccess(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  // console.log(data)
  var surveyId = store.surveyId;
  api.update(surveyId, data).then(ui.updateSuccess).catch(ui.updateFailure);
};

var onShowSuccess = function onShowSuccess(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  // console.log('data is ', data)
  api.show(data).then(function (data) {
    ui.getSuccess(data);
    ui.checkUser(data);
  }).catch(ui.failure);
};

var onDestroySurvey = function onDestroySurvey(event) {
  event.preventDefault();
  var surveyId = $(this).attr('data-id');
  api.destroy(surveyId).then(ui.deleteSuccess).catch(ui.failure);
};

var onViewResults = function onViewResults(event) {
  event.preventDefault();
  // console.log(survey.id)
  var surveyId = $(this).attr('data-id');
  // console.log('Survey Id is ', surveyId)
  var ans1 = $(this).siblings()[5];
  var ans2 = $(this).siblings()[10];
  $(ans1).show();
  $(ans2).show();
  api.show(surveyId).then(function (data) {
...
var onRefresh = function onRefresh(event) {
  event.preventDefault();
  api.index().then(function (data) {
    ui.getSuccess(data);
    ui.checkUser(data);
...
var showSurveyTemplate = __webpack_require__(19);
...
var getSuccess = function getSuccess(data) {
  ...
  var showSurveyHTML = showSurveyTemplate({
...
var onVote = function onVote(event) {
  ...
  if (answer !== undefined) {
    ...
    }).then(voteSuccess).catch(voteFailure);
  } else {
    voteFailure();
  }
};

var checkUser = function checkUser(data) {
...
var onEditSurvey = function onEditSurvey(event) {
  event.preventDefault();
  var surveyTitle = $(this).siblings()[0];
  var question = $(this).siblings()[1];
  var response1 = $(this).siblings()[3];
  var response2 = $(this).siblings()[8];
...
var onSurveyEdit = function onSurveyEdit(surveyId, surveyTitle, question, response1, response2) {
  // const surveyId = $(this).attr('data-id')
  var newTitle = $(surveyTitle).html();
  var newQuestion = $(question).html();
  var newResponse1 = $(response1).html();
  var newResponse2 = $(response2).html();
  ...
  if (newQuestion !== '' && newResponse1 !== '' && newResponse2 !== '') {
    ...
    api.update(surveyId, data).then(editSuccess).catch(editFailure);
  } else {
    editSurveyFailure();
  }
};
...
// <-----  edit survey event for showing form ---->
var voteSuccess = function voteSuccess(event) {
  api.index().then(function (data) {
    getSuccess(data);
    checkUser(data);
...
var editSuccess = function editSuccess(event) {
...
var viewResultSuccess = function viewResultSuccess(data) {
  // console.log('data is ', data)
...
var editFailure = function editFailure(data) {
  // console.log('error is', data)
  $('#message').text('Edit failed!').fadeIn().delay(4000).fadeOut();
};

var editSurveyFailure = function editSurveyFailure(data) {
  // console.log('error is', data)
  $('#message').text('Input must have content!').fadeIn().delay(4000).fadeOut();
};
var resultFailure = function resultFailure(data) {
  // console.log('error is', data)
  $('#message').text('Get results failed!').fadeIn().delay(4000).fadeOut();
};

var voteFailure = function voteFailure(event) {
...
module.exports = {
  ...
  viewResultSuccess: viewResultSuccess,
  resultFailure: resultFailure,
  voteSuccess: voteSuccess,
  voteFailure: voteFailure,
  editSurveyFailure: editSurveyFailure
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "  <div data-id=\""
    ...
    + "</h3>\n"
    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),((stack1 = blockParams[0][0]) != null ? stack1.questions : stack1),{"name":"each","hash":{},"fn":container.program(2, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "    <button data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" type=\"submit\" class=\"vote\">Vote</button>\n    <button data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" type=\"submit\" class=\"view-results\">View Results</button>\n    <button data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" class=\"edits-survey\" value=\"edit\">Edit</button>\n    <button data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" class=\"delete-survey\" value=\"delete\">Delete</button>\n  </div>\n\n";
},"2":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return "      <h4>"
    + container.escapeExpression(container.lambda(((stack1 = blockParams[0][0]) != null ? stack1.content : stack1), depth0))
    + "</h4>\n"
    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),((stack1 = blockParams[0][0]) != null ? stack1.responses : stack1),{"name":"each","hash":{},"fn":container.program(3, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
},"3":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1, alias1=container.lambda, alias2=container.escapeExpression;

  return "        <input type=\"radio\" name=\"answer\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.answer1 : stack1), depth0))
    + "\"><h5>"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.answer1 : stack1), depth0))
    + "</h5>\n          <p data-id=\""
    + alias2(alias1(((stack1 = blockParams[2][0]) != null ? stack1.id : stack1), depth0))
    + "\" type=\"text\" class=\"count\" name=\"answer1Count\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.answer1Count : stack1), depth0))
    + "\"><h5 class=\"vote-tally\">Vote Tally:"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.answer1Count : stack1), depth0))
    + "</h5></p>\n        <input type=\"radio\" name=\"answer\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.answer2 : stack1), depth0))
    + "\"><h5>"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.answer2 : stack1), depth0))
    + "</h5>\n          <p data-id=\""
    + alias2(alias1(((stack1 = blockParams[2][0]) != null ? stack1.id : stack1), depth0))
    + "\" type=\"text\" class=\"count\" name=\"answer2Count\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.answer2Count : stack1), depth0))
    + "\"><h5 class=\"vote-tally\">Vote Tally:"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.answer2Count : stack1), depth0))
    + "</h5></p>\n";
  ...
  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.surveys : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "<!-- const createInput = function () {\nconst $input = $('<input type=\"submit\" class=\"edits-survey\" value=\"edit\">')\n$input.appendTo($('.feed'))\n} -->\n";
